    ...
    <div>        
            ...
            <div class="section" v-else>
                ...
                <div class="md-layout md-alignment-center">
                    ...
                    <md-table class="" v-model="squad">
                        ...
                        <md-table-row v-for="player in squad" :key="player.id">                            
                            <md-table-cell md-sort-by="position" md-numeric>{{player.position}}</md-table-cell>
                            <md-table-cell>
                                <img class="logo" alt="pais"  :src="getFlagUrl(player.nationality)">
                            </md-table-cell>
                            <md-table-cell>                                
                                {{player.name}}
                            </md-table-cell>
                ...
                <div class="md-layout md-alignment-center">
                    ...
                    <md-button class="md-primary md-round" @click="returnToLeague()">Volver al Menú</md-button>
...
export default {
    ...
    methods : {
        ...
        getFlagCode(nationality){
            let flagCode = this.countryCodes.filter( flag => flag.country_name == nationality);

            if(flagCode.length > 0){
                return flagCode[0].country_code;
            }
            else{
                return '';
            }
        ...
        getFlagUrl(nationality){
            let country_code = this.getFlagCode(nationality);

            if (country_code != ''){
                return this.link + country_code.toLowerCase() + ".svg";
            }
            else{
                return "";
            }
    ...
    data(){
        return {
            ...
            sort_name : false,
            sort_position : false,
            sort_birthdate : false,

            link : "https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/",
            "countryCodes": [
            {
			    "country_code": "AF",
